...
const ui = {
  ...
  topCompanyLogo: document.querySelector("[data-hm-brand-logo]"),
  ...
  profileAvatar: document.querySelector("[data-hm-profile-avatar]"),
  ...
  profileCompletion: document.querySelector("[data-hm-profile-completion]"),
...
function profileInitials(record, fallback = "HM") {
...
function renderTopCompanyName() {
  ...
  const logoUrl = resolveCompanyLogoUrl(hmState.currentProfile);
  if (!logoUrl) {
  ...
  ui.topCompanyLogo.alt = `${resolveCompanyName(hmState.currentProfile)} logo`;
...
function renderProfilePanel() {
  ...
  setText(ui.profileAvatar, profileInitials(profile, "HM"));
